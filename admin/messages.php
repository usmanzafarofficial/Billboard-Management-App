...
// Fetch all advertisers (for sending messages)
$stmt = $pdo->query("SELECT id, name FROM users WHERE user_type_id = 2"); // Only advertisers
...
<div class="container mt-3">
    ...
    <!-- Add a dropdown to select the advertiser -->
    <div class="mb-3">
        <label for="selected_receiver_id" class="form-label">Select Advertiser</label>
